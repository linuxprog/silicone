import { getSupabaseBackend, initSupabaseBackend } from '@core/services/supabaseAuthBackend';
...
const initAuthBackend = () => {
    if (environment.defaultauth === 'firebase') {
      return initFirebaseBackend(environment.firebaseConfig);
    } else if (environment.defaultauth === 'supabase') {
      return initSupabaseBackend(environment.supabaseConfig);
    }
    return null;
  };
...
export { initFirebaseBackend, getFirebaseBackend,initAuthBackend, getAuthBackend  };
